%% COMPARISON SCRIPT: PROPOSED METHOD (STT) vs. SAFETY BARRIER CERTIFICATES " L. Wang, A. D. Ames, and M. Egerstedt. Safety barrier certificates for collisions-free multirobot systems. "
clc; clear; close all;
